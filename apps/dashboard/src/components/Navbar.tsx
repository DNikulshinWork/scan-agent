      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-red-600 to-rose-700 flex items-center justify-center shadow-lg shadow-rose-950/50">
              <span className="text-white font-black text-lg tracking-wider">HH</span>
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="text-lg font-bold text-white tracking-tight">ScanAgent</span>
                ...
                {backendOnline !== undefined && (
                  ...
                  >
                    ...
                    {backendOnline ? 'API Online' : 'Client Mode'}
                  </span>
                )}
              </div>
          ...
          <div className="flex items-center gap-2">
            {onOpenSettings && (
              <button
                ...
                className="p-2 text-gray-400 hover:text-gray-200 hover:bg-gray-800 rounded-xl border border-gray-800 transition"
            ...
            <button
              ...
              disabled={isScanning}
              className="flex items-center gap-2 px-3.5 py-2 text-sm font-medium rounded-xl bg-rose-600 hover:bg-rose-500 disabled:opacity-50 text-white shadow-lg shadow-rose-900/20 transition-colors"
